...
class DiffusionSampler_base(object):
    ...
    """
    def __init__(self, model, scheduler, timesteps=200, **scheduler_kwargs):
        r"""
    ...
    def p_sample_loop(self, shape, batch=None, c=None, *args, **kwargs):
        ...
        for t_i in tqdm(range(self.total_timestep, 0, -1), "Q sampling", total=self.total_timestep):
...
class DDPM_Sampler(DiffusionSampler_base):
    ...
    def __init__(self, model : nn.Module,
                       ...
                       timesteps=200, 
                       **scheduler_kwargs):
        super().__init__(model, scheduler, timesteps, **scheduler_kwargs)
...
class DDIM_Sampler(DiffusionSampler_base):
    ...
    def __init__(self, 
        ...
        super().__init__( model, scheduler, timesteps)
    ...
    def _compute_ddim_alphas(self):
        ...
        #a_{t-1}
        self.a_prev = torch.cat([alpha_bar[0], alpha_bar[self.time_steps[:-1]]])
        #√1-a
    ...
    def p_sample(self, x_t, t, noise=None,  batch=None, c=None, no_var=False, *args, **kwargs):
        ...
        sigma_t = self.extract(self.sigma, t, x_t.shapes)
